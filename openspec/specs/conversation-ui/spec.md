...
The system SHALL provide a web-based chat interface allowing authenticated HR agents to start, view, and participate in conversational analysis sessions — with routes, controllers, policies, and views scoped to the user's own data.
