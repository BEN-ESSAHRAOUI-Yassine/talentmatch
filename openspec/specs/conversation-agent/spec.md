...
The system SHALL provide a Layer 2 conversational agent (`AnalyseConversationAgent`) that HR agents can interact with via persistent chat — using tools to retrieve real analysis data, job requirements, and candidate comparisons without fabricating information.
