...
Allow authenticated users to view the full AI analysis results for a candidate submitted against their job offer, including three distinct states: pending (loading indicator), completed (all extracted fields), and failed (error message).
